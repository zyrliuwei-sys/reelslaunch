    ...
    <>
      ...
      <article className="mx-auto max-w-4xl px-5 py-16 text-neutral-300 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-base leading-7">
          H3 Max text to video turns a written direction into a short clip you
          can review, refine, and use in a publishing workflow. Describe the
          subject, action, setting, camera movement, and mood in one prompt; the
          generator uses those details to shape a coherent shot instead of
          asking you to assemble a timeline first. Create clips from 5 to 15
          seconds and choose from six aspect ratios for vertical Reels, square
          social posts, or wider video placements. You can begin with text and
          keep the creative direction in one workspace from the first draft
          onward.
        </p>
        <p className="mt-5 text-base leading-7">
          Choose resolution and duration together. 480p is a practical option
          when you want to explore more seconds or test several prompt ideas
          while keeping generation spend predictable. 768p gives a frame more
          detail when texture, lighting, or a close subject matters. H3 Max
          video generation is priced by the second, so the selected resolution
          and clip length determine the generation cost. A shorter 480p draft
          can help validate motion before you spend more on a detailed render;
          once the direction works, adjust the duration or resolution to fit the
          finished post.
        </p>
        <p className="mt-5 text-base leading-7">
          ...
          result, then add it to a queue and schedule it for Instagram Reels.
          Set the publishing cadence once and keep preparing the next clips
          while the schedule runs. If you are comparing workflows, return to the{' '}
          ...
          <div className="mt-5 divide-y divide-white/10 border-y border-white/10">
            <details className="py-4">
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-neutral-400">
                ...
                per-second rate, so review the selected resolution, duration,
                and available balance before submitting a clip.
              </p>
            </details>
            <details className="py-4">
              <summary className="cursor-pointer font-medium text-white">
